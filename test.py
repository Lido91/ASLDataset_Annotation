...
data = np.load(r"E:\Github\ASL-Dataset-Preprocess\dataset\test_mediapipe_output\6dKIcUCzRHc-000.npy")
print(data.shape)
print(data)
...
# video_dir = f'{root}/dataset/test/'
# output_dir = f'{root}/dataset/test_output/'
